...
public class dlgNewClustering extends GlassDialog {
    ...
    public dlgNewClustering(Frame parent, Dataset[] ds) {
        ...
        Class<DistanceMeasure>[] c = new Class[]{AngularDistance.class, EuclideanDistance.class};
    ...
    private void initComponents() {
        ...
        chkPSS = new javax.swing.JCheckBox();
        ...
        chkPSS.setText("Compute PSS");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        panIndependentClustering.add(chkPSS, gridBagConstraints);

        jLabel1.setText("Post-processing:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 5;
        panIndependentClustering.add(jLabel1, gridBagConstraints);
    ...
    private void cmbAlgorithmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbAlgorithmActionPerformed
        ...
        JPanel pan = ((ClusteringCore) cmbAlgorithm.getSelectedItem()).getParamControlPanel();
    ...
    private class ClusteringCoreComboBoxRenderer extends BasicComboBoxRenderer {
        ...
        public Component getListCellRendererComponent(JList list, Object value,
            ...
            ClusteringCore cc = null;
            if (ClusteringCore.class.isAssignableFrom(value.getClass())) {
                cc = (ClusteringCore) value;
            }
            if (isSelected) {
    ...
    private class ClusteringWorker extends SwingWorker<ClusterSet[][], ClusterSet> {
        ...
        public ClusteringWorker(ClusteringCore core) {
            this.core = core;
        }
    ...
    private void cmdDoClusteringActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDoClusteringActionPerformed
        ...
        worker = new ClusteringWorker(((ClusteringCore) cmbAlgorithm.getSelectedItem()));
        worker.execute();
    ...
    private void cmbDistanceMeasureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbDistanceMeasureActionPerformed
        ...
        for (ClusteringCore cc : new ClusteringCore[]{new XShiftClustering(getDistanceMeasure()),
            new MeanShiftClusteringCore(getDistanceMeasure()),
            new HierarchicalClusteringCore(getDistanceMeasure()),
            new KMeansCore(getDistanceMeasure()),
    ...
    private javax.swing.JCheckBox chkPSS;
