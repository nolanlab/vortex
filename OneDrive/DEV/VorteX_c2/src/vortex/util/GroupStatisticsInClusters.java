...
public class GroupStatisticsInClusters {
    ...
    public static double[][] getGroupStatisticsVectors(Cluster[] cl, Annotation ann, boolean relative) throws SQLException {
    ...
    public static double[][] getGroupStatisticsFunctionalVectors(Cluster[] cl, Annotation ann, boolean relative) throws SQLException {
