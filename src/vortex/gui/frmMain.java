...
public class frmMain extends javax.swing.JFrame {
    ...
    public frmMain() {
        ...
        PrintStream ls = new PrintStream(new LoggerStream(new ByteArrayOutputStream(), System.err));
    ...
    private void initComponents() {
        ...
        frmFind = new samusik.glasscmp.GlassFrame();
        cmdDoFind = new samusik.glasscmp.GlassButton();
        txtFind = new samusik.glasscmp.GlassEdit();
        ...
        frmFind.setBackground(new Color(0,0,0,0));
        frmFind.setBounds(new java.awt.Rectangle(300, 200, 400, 90));
        frmFind.setMaximizedBounds(new java.awt.Rectangle(300, 200, 400, 90));
        frmFind.setMinimumSize(new java.awt.Dimension(400, 90));
        frmFind.setUndecorated(true);
        frmFind.setResizable(false);
        frmFind.getContentPane().setLayout(new java.awt.GridBagLayout());

        cmdDoFind.setText("Find");
        cmdDoFind.setMaximumSize(new java.awt.Dimension(73, 30));
        cmdDoFind.setMinimumSize(new java.awt.Dimension(73, 30));
        cmdDoFind.setPreferredSize(new java.awt.Dimension(73, 30));
        cmdDoFind.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdDoFindActionPerformed(evt);
            }
        });
        ...
        frmFind.getContentPane().add(cmdDoFind, gridBagConstraints);

        txtFind.setMinimumSize(new java.awt.Dimension(400, 30));
        txtFind.setPreferredSize(new java.awt.Dimension(400, 30));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        frmFind.getContentPane().add(txtFind, gridBagConstraints);
    ...
    private void cmdDoFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDoFindActionPerformed
    }//GEN-LAST:event_cmdDoFindActionPerformed
    ...
    private samusik.glasscmp.GlassButton cmdDoFind;
    private javax.swing.JFrame frmFind;
    ...
    private samusik.glasscmp.GlassEdit txtFind;
