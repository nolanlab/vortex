...
import vortex.gui.DatasetBrowser.DatasetSelectionEvent;
...
public class ClusteringResultList extends javax.swing.JPanel implements DatasetBrowser.DatasetSelectionListener {
    ...
    ArrayList<ClusterSetSelectionListener> listeners = new ArrayList<ClusterSetSelectionListener>();
    ...
    private void initComponents() {
        ...
        cmdDeleteClusterSets1 = new samusik.glasscmp.GlassButton();
        ...
        cmdNewClustering.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vortex/resources/icon-plus_32.png"))); // NOI18N
        ...
        cmdDeleteClusterSets.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vortex/resources/Close.png"))); // NOI18N
        ...
        cmdDeleteClusterSets1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vortex/resources/icon_search_32.png"))); // NOI18N
        cmdDeleteClusterSets1.setToolTipText("Search Profiles");
        cmdDeleteClusterSets1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        cmdDeleteClusterSets1.setIconTextGap(0);
        cmdDeleteClusterSets1.setMargin(new java.awt.Insets(2, 2, 2, 2));
        cmdDeleteClusterSets1.setMaximumSize(new java.awt.Dimension(36, 35));
        cmdDeleteClusterSets1.setMinimumSize(new java.awt.Dimension(36, 35));
        cmdDeleteClusterSets1.setPreferredSize(new java.awt.Dimension(36, 35));
        cmdDeleteClusterSets1.setVerifyInputWhenFocusTarget(false);
        cmdDeleteClusterSets1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdDeleteClusterSets1ActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(7, 5, 7, 7);
        toolbar.add(cmdDeleteClusterSets1, gridBagConstraints);
    ...
    private void cmdDeleteClusterSets1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteClusterSets1ActionPerformed
        new FrmFind().setVisible(true);
    }//GEN-LAST:event_cmdDeleteClusterSets1ActionPerformed
    ...
    private void pmiExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pmiExportActionPerformed
        if (getSelectedClusterSets().length > 0) {
            (new dlgExportClusterSet(frmMain.getInstance(), getSelectedClusterSets())).setVisible(true);
        }
    ...
    private void pmiStatsPerGroupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pmiStatsPerGroupActionPerformed
        ...
        try {
            ...
            DefaultTableModel otm = GroupStatisticsInClusters.getGroupStatistics(getSelectedClusterSets()[0], ann, false);
    ...
    private void pmiExportFCSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pmiExportFCSActionPerformed
        /*try {
            File f = frmMain.chooseFileWithDialog("ExportToFCS", "Directories", new String[]{}, toolbarVisible);
            ClusterSetToFCSExporter.exportClusterSet(getSelectedClusterSets()[0], f);
    ...
    private void pmiElbowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pmiElbowActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "x = " + bestX + "by LinePlusExp");
        ...
        try {
            ...
            for (ClusterSet cs : css) {
                ...
                for (String term : ann.getTerms()) {
                    String[] pidT = ann.getProfileIDsForTerm(term);
    ...
    private samusik.glasscmp.GlassButton cmdDeleteClusterSets1;
