...
public abstract class Kernel implements Serializable {
    ...
    public abstract double[] getWeightedMean(double[] center, double[][] vectors);
    ...
    protected abstract double getNonNormalizedValue(double[] center, double[] vector);

    protected abstract double getNormalizationConst(double[] center);

    public abstract BigDecimal getDensity(double[] center, double[][] vectors);
    ...
    public abstract void fitBandwidth(double[] center, double[][] vectors);
}
