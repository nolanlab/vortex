...
public class XshiftParamPanel extends javax.swing.JPanel {
    ...
    public int getNSize(Dataset ds){
        ...
        return (int) (Math.max(0.5*(ds.getDimension() + 1), -(int) Math.ceil(Math.log(pVal / ds.size()) / Math.log(2))));}else{
    ...
    private void initComponents() {
        ...
        spinNSize.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(150), null, null, Integer.valueOf(1)));
