...
import vortex.gui.ClusteringResultList.ClusterSetSelectionListener;
...
public class ModelBasedClusteringParamPanel extends javax.swing.JPanel {
    ...
    public ModelBasedClusteringParamPanel(Dataset ds) {
        ...
        csb.addClusterSetSelectionListener(new ClusterSetSelectionListener() {
            @Override
            public void clusterSetSelected(ClusterSetSelectionEvent evt) {
                selectedCS = evt.getSource();
            }
        });
