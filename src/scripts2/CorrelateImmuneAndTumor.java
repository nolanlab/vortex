    ...
    public static void main(String[] args) throws Exception{
        ...
        for (int i = 0; i < dim; i++) {
            for (int j = i + 1; j < dim; j++) {
                ...
                logger.print(immune.getDatapoints()[i].getName() + "\t"+ immune.getDatapoints()[j].getName() + "\t" + tumor.getDatapoints()[i].getName() + "\t"+ tumor.getDatapoints()[j].getName() + "\t"+ Correlation.getUncenteredCorrelation(immune.getDatapoints()[i].getVector(), immune.getDatapoints()[j].getVector()) + "\t" + Correlation.getUncenteredCorrelation(tumor.getDatapoints()[i].getVector(), tumor.getDatapoints()[j].getVector()) );
            }
        }
    }
