...
/**
 * ArrayList manipulation tools. READY
 *
...
public class VectorTools {
    ...
    public static double[][] fast_pow(double[][] from, int power) {
        double[][] ret = new double[from.length][from[0].length];
        for (int x = 0; x < from.length; x++) {
            for (int y = 0; y < from[0].length; y++) {
                ret[x][y] = from[x][y];
    ...
    /**
     * Pointwise multiplication of two ArrayLists.
     *
     * @param v1
     * @param v2
     * @return
    ...
    /**
     * Sum the entire set of ArrayLists.
     *
     * @param ArrayLists	Set of ArrayLists.
     * @return
     */
    public static double[] sumArrayLists(ArrayList<double[]> ArrayLists) {
        if (ArrayLists.size() <= 0) {
            return null;
        }

        double[] ret = new double[ArrayLists.get(0).length];
    ...
    /**
     * Shift elements in ArrayList times to the right with rotation at the ends.
     *
     * @param v
     * @param times
     * @return
    ...
    /**
     * Limit the length of the ArrayList to be len if it is greater.
     *
     * @param v
     * @param len
     * @return
    ...
    /**
     * Get the ArrayList that is a fraction of the way between two points.
     *
     * @param from
     * @param to
     * @param amount
    ...
    /**
     * Add the first ArrayList to the second one.
     *
     * @param from
     * @param to
     */
    ...
    /**
     * Get the result of adding two ArrayLists.
     *
     * @param from
     * @param to
     * @return
    ...
    /**
     * Set this ArrayList to the result of subtracting the other.
     *
     * @param from
     * @param to
     */
    ...
    /**
     * Subtract everything in the first ArrayList from the second.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Distance between two ArrayLists.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Dot product between two ArrayLists.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Multiply each point in the ArrayList by b.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Set the length of the ArrayList.
     *
     * @param a
     * @param len
     * @return
    ...
    /**
     * Perform convolution of ArrayList a with b.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Random indicator ArrayList of 0 or 1s.
     *
     * @param len
     * @return
     */
