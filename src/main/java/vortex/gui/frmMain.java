...
public class frmMain extends javax.swing.JFrame {
    ...
    public JFrame createFrame() {
        ...
        Rectangle2D r = frmMain.getInstance().getBounds();
        Rectangle2D r2 = new Rectangle2D.Double(r.getX() + r.getWidth() * 0.05, r.getY() + r.getHeight() * 0.05, r.getWidth() * 0.9, r.getHeight() * 0.9);
        Rectangle r3 = new Rectangle((int) r2.getX(), (int) r2.getY(), (int) r2.getWidth(), (int) r2.getHeight());
        jf.setBounds(r3);
        return jf;
    }
    ...
    public frmMain() {
        ...
        try {
            ...
            UIManager.getLookAndFeelDefaults().put("ScrollBar.minimumThumbSize", new Dimension(20, 30));
            UIManager.put("Table.rowHeight", 12);
            UIManager.put("TableHeader.height", 20);
        ...
        try {
            Image img = new javax.swing.ImageIcon(getClass().getResource("/vortex.png")).getImage();
    ...
    public ClusteringResultList getClusteringResultList() {
        return cssb;
    }
