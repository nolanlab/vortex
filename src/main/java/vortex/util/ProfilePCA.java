...
public class ProfilePCA {
    ...
    public static DenseDoubleMatrix1D[] getPrincipalComponents(Datapoint[] datapoints, boolean unityLen) {
        ...
        Arrays.sort(out, new Comparator<DenseDoubleMatrix1D>() {
            @Override
            public int compare(DenseDoubleMatrix1D o1, DenseDoubleMatrix1D o2) {
                return (int) Math.signum(MatrixOp.lenght(o2.toArray()) - MatrixOp.lenght(o1.toArray()));
            }
        });
        return out;
    }
