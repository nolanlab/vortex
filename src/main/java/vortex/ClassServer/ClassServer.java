 ...
 * extended and the concrete subclass should define the <b>getBytes</b>
 * method which is responsible for retrieving the bytecodes for a class.<p>
 *
...
public abstract class ClassServer implements Runnable {
     ...
     * @exception IOException if the ClassServer could not listen on
     * <b>port</b>.
     */
     ...
     */
    private static String getPath(DataInputStream in2)
            throws IOException {
